...
@AutoConfigureWebTestClient public class EnergyResourcesControllerTest {
    @Test void testPostBatteryEventReturnsValidBatteryEvent(
        @Autowired WebTestClient client) throws IOException {
